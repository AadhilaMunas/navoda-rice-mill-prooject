...
<html lang="en">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLongTitle">Vendor Registration</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                            <form action="register_vendor.php" method="POST" class="lorryform">
                                <div class="form-group">
                                    
                                    <input type="text" class="form-control" name="cus_name" id="paddy" placeholder="Vendor Name">
                                  </div>
                    
                                  <div class="form-group">
                                    
                                    <input type="text" class="form-control" name="cus_nic"  id="rice" placeholder="Vendor NIC">
                                  </div>
                ...
                <?php
                            ...
                            $sql="INSERT INTO `tbl_vendor_registration`(`vendor_NIC`, `vendor_name`, `shop_name`, `maximum_quota`, `bank_name`, `bank_branch`, `account_name`, `contact_number`)
                             VALUES
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h4 mb-2 text-gray-800"></h1>
                        ...
                        <span class="insert-data-emoji">&#x1F4C4; Register Vendor here..</span>
                          </button>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <?php
                                  ...
                                  $sql = "SELECT `id`, `vendor_NIC`, `vendor_name`, `bank_name`, `bank_branch`, `account_name`, `contact_number` FROM `tbl_vendor_registration` ";
...
function removeRow(rowId) {
  if (confirm("Are you sure you want to delete this row?")) {
    ...
    xhr.open('POST', 'register_vendor.php');
